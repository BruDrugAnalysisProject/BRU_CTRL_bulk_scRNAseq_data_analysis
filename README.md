...
The bulk RNA-seq data was deposited on OMIX (https://ngdc.cncb.ac.cn/omix/), OMIX ID is OMIX016555, https://ngdc.cncb.ac.cn/omix/preview/xwreBAui
...
The single-cell RNA-seq data has been deposited in the GSA (https://ngdc.cncb.ac.cn/gsa/) under accession ID HRA028683 (updated from HRA025246) under the same project PRJCA056072 and is currently being reviewed by the NGDC.
